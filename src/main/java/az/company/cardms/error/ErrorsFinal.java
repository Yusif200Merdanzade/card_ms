package az.company.cardms.error;

import az.company.cardms.exception.ErrorResponse;
...
//    JWT_ERROR("JWT_ERROR",HttpStatus.UNAUTHORIZED,"{message}"),
    ...
    EMPLOYEE_NOMENCLATURE_NOT_FOUND_FOR_USER("EMPLOYEE_NOMENCLATURE_NOT_FOUND_FOR_USER", HttpStatus.NOT_FOUND, "User'ə bağlı nomenklatura tapilmadı"),
